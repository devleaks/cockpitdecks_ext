...
class FMAIcon(DrawBase):
    ...
    def check_boxed(self):
        ...
        """
        boxed = []
        if self.button.get_simulator_data_value("AirbusFBW/FMAAPLeftArmedBox") == 1:
            boxed.append("22")
        if self.button.get_simulator_data_value("AirbusFBW/FMAAPLeftModeBox") == 1:
            boxed.append("21")
        if self.button.get_simulator_data_value("AirbusFBW/FMAAPRightArmedBox") == 1:
            boxed.append("32")
        if self.button.get_simulator_data_value("AirbusFBW/FMAAPRightModeBox") == 1:
            boxed.append("31")
        if self.button.get_simulator_data_value("AirbusFBW/FMAATHRModeBox") == 1:
            boxed.append("11")
        if self.button.get_simulator_data_value("AirbusFBW/FMAATHRboxing") == 1:
            boxed.append("12")
        if self.button.get_simulator_data_value("AirbusFBW/FMAATHRboxing") == 2:
            boxed.append("11")
            boxed.append("12")
        if self.button.get_simulator_data_value("AirbusFBW/FMATHRWarning") == 1:
            boxed.append(WARNING)
        # big mess:
        boxcode = self.button.get_simulator_data_value("AirbusFBW/FMAAPFDboxing")
